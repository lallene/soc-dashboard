...
import { getAnalysis, getHistory, uploadLog } from "./api";
    ...
    switch (activeSection) {
      ...
      case "logs":
        return renderPlaceholder(
          "Analyse des Logs",
          "Cette section accueillera l’analyse détaillée des fichiers de logs, avec recherche, filtres et incidents détaillés."
        );
      case "vulnerabilities":
        return renderPlaceholder(
          "Vulnérabilités",
          "Cette section servira à importer et analyser les fichiers de vulnérabilités."
        );
      case "cve":
        return renderPlaceholder(
          "CVE Explorer",
          "Cette section permettra la recherche et la consultation des CVE."
        );
      case "remediation":
        return renderPlaceholder(
          "Remédiation",
          "Cette section affichera les recommandations de correction et de mitigation."
        );
      case "analytics":
        return renderPlaceholder(
          "Analytics",
          "Cette section regroupera les statistiques avancées, tendances et indicateurs SOC."
        );
      case "settings":
        return renderPlaceholder(
          "Paramètres",
          "Cette section contiendra la configuration du dashboard et des connexions API."
        );
      default:
        return renderDashboard();
    }
